...
if __name__ == '__main__':
    ...
    train_img_dir = 'C:/Users/admin\Documents\GitHub\PSDNN\datasets/partA/train_data/images'
    train_gt_dir = 'C:/Users/admin\Documents\GitHub\PSDNN\datasets/partA/train_data/ground_truth'
    exemplars_dir = 'C:/Users/admin\Documents\GitHub\PSDNN\datasets/partA//examplars'  # Ensure exemplars exist here
    test_img_dir = 'C:/Users/admin\Documents\GitHub\PSDNN\datasets/partA/test_data/images'
    ...
    train_dataset = CrowdCountingDataset(
        ...
        num_exemplars=3, resize_shape=(768, 768), crop_size=(384, 384)
    )
    ...
    model.load_state_dict(torch.load("C:/Users/admin\Documents\GitHub\PSDNN\YCV/best-model.pth")['model'])
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        for batch_idx, (images, gt_density, exemplars, scales, gt_count, gt_map) in enumerate(train_loader):
            ...
            pred_count = pred_density.sum().item()/360  # Convert to scalar properly
