...
class CACViT(nn.Module):
    def __init__(self, num_exemplars=3, img_size=384, patch_size=16, embed_dim=768):
        ...
        #     ResidualBlock(64),
        #
        #     # Final refinement to produce the density map
        #     nn.Conv2d(64, 32, kernel_size=3, padding=1),
        #     nn.BatchNorm2d(32),
        #     nn.ReLU(inplace=True),
        #     nn.Conv2d(32, 1, kernel_size=1),
        #     nn.ReLU(inplace=True)  # Ensures non-negative density values
        # )
    ...
    def forward(self, inputs):
        ...
        exemplar_features = exemplar_features.view(batch_size, (self.num_exemplars+1), self.num_patches_exemplar,
                                                   self.embed_dim)
